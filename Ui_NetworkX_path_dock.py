...
#
# Created: Fri Jan 13 12:07:00 2012
...
class Ui_NetworkXPath(object):
    def setupUi(self, NetworkXPath):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/plugins/NetworkX/icon/coordinate_capture.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, NetworkXPath):
        ...
        self.btnReload.setText(QtGui.QApplication.translate("NetworkXPath", "Clear/Reload", None, QtGui.QApplication.UnicodeUTF8))
